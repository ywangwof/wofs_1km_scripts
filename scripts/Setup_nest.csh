...
echo "setenv REF_DIR /scratch/wofs_1km/OBSGEN/REF" >> ${TOP_DIR}/realtime.cfg.${event}
echo "setenv VEL_DIR /scratch/wofs_1km/OBSGEN/VEL" >> ${TOP_DIR}/realtime.cfg.${event}
...
### Set grid dimensions
echo "setenv grdpts_ew 403" >> ${TOP_DIR}/realtime.cfg.${event}
echo "setenv grdpts_ns 403" >> ${TOP_DIR}/realtime.cfg.${event}
...
echo "setenv EKF_CORES 600" >> ${TOP_DIR}/realtime.cfg.${event}
...
echo "setenv INF_CORES 80" >> ${TOP_DIR}/realtime.cfg.${event}
...
echo "setenv NLONS 402" >> ${TOP_DIR}/realtime.cfg.${event}
echo "setenv NLATS 402" >> ${TOP_DIR}/realtime.cfg.${event}
