...
EOF
       ...
       echo '#SBATCH' "-p batch"                                                         >> ${RUNDIR}/ic${emember}/cycle_1h_${ICYC}/icbc_1h_${ICYC}.csh
       echo '#SBATCH' "--mem-per-cpu=5G"                                             >> ${RUNDIR}/ic${emember}/cycle_1h_${ICYC}/icbc_1h_${ICYC}.csh
       echo '#SBATCH' "-n 6"                                                            >> ${RUNDIR}/ic${emember}/cycle_1h_${ICYC}/icbc_1h_${ICYC}.csh
