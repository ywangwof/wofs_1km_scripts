...
#            @ n2 = ${n} - ${count}
 #           if ( $n2 > 9 ) then
  ...
  #          else
   #            ${RUNDIR}/WRF_RUN/link_grib.csh ${HRRRE_DIR}/${event}/${anlys_hr}00/mem$n2/wrfnat_hrrre_newse_mem000${n2}_01.grib2 .
...
echo '#SBATCH' "--mem-per-cpu=10G"                                            >> ${RUNDIR}/ungrib_mem.csh
echo '#SBATCH -t 01:00:00'                                                    >> ${RUNDIR}/ungrib_mem.csh
echo "#=================================================================="   >> ${RUNDIR}/ungrib_mem.csh
echo " "                                                                     >> ${RUNDIR}/ungrib_mem.csh
echo "set echo"                                                              >> ${RUNDIR}/ungrib_mem.csh
echo "source /scratch/wofs_1km/wofs_1km_scripts/WOFenv_rto_d01"                            >> ${RUNDIR}/ungrib_mem.csh
...
echo '#SBATCH' "--mem-per-cpu=5G"                                            >> ${RUNDIR}/ungrib_mem.csh
echo '#SBATCH' "-n 12"                                                        >> ${RUNDIR}/metgrid_mem.csh
echo '#SBATCH -t 00:30:00'                                                   >> ${RUNDIR}/metgrid_mem.csh
echo "#=================================================================="   >> ${RUNDIR}/metgrid_mem.csh
echo " "                                                                     >> ${RUNDIR}/metgrid_mem.csh
echo "set echo"                                                              >> ${RUNDIR}/metgrid_mem.csh
echo "source /scratch/wofs_1km/wofs_1km_scripts/WOFenv_rto_d01"                            >> ${RUNDIR}/metgrid_mem.csh
