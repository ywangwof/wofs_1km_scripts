...
###
    ...
    echo '#SBATCH' "-A largequeue"                                                    >> ${RUNDIR}/mem${emember}/icbc_bc1.csh
    echo '#SBATCH' "-p workq"                                                         >> ${RUNDIR}/mem${emember}/icbc_bc1.csh
    echo '#SBATCH' "--ntasks-per-node=24"                                             >> ${RUNDIR}/mem${emember}/icbc_bc1.csh
    echo '#SBATCH' "-n 48"                                                            >> ${RUNDIR}/mem${emember}/icbc_bc1.csh
