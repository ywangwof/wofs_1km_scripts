...
echo "setenv REF_DIR /scratch/wofs_1km/OBSGEN/REF/D02" >> ${TOP_DIR}/retro.cfg.${event}
echo "setenv VEL_DIR /scratch/wofs_1km/OBSGEN/VEL/D02" >> ${TOP_DIR}/retro.cfg.${event}
...
### Set grid dimensions
echo "setenv grdpts_ew 403" >> ${TOP_DIR}/retro.cfg.${event}
echo "setenv grdpts_ns 403" >> ${TOP_DIR}/retro.cfg.${event}
...
echo "setenv fts 15" >> ${TOP_DIR}/retro.cfg.${event}
...
echo "setenv INF_NODES 3" >> ${TOP_DIR}/retro.cfg.${event}
echo "setenv WRF_CORES 48" >> ${TOP_DIR}/retro.cfg.${event}
echo "setenv WRF_FCORES 72" >> ${TOP_DIR}/retro.cfg.${event}
...
echo "setenv OUTLIER 7" >> ${TOP_DIR}/retro.cfg.${event}
...
echo "setenv NLONS 402" >> ${TOP_DIR}/retro.cfg.${event}
echo "setenv NLATS 402" >> ${TOP_DIR}/retro.cfg.${event}
...
set imem = 1
while ( ${imem} <= 36 )
  mkdir ${RUNDIR}/ic${imem}
  mkdir ${RUNDIR}/mem${imem}
  @ imem++
end
...
cp -R ${TEMPLATE_DIR}/input.nml.conv1.1km ./input.nml 
cp -R ${TEMPLATE_DIR}/namelists.WOFS.nested/namelist.input.member1 namelist.input
