...
while ( $n <= $ENS_SIZE )
      ...
      #@ anlys_hr = ${start_hr} - 1
        ...
        ### NEW LBCs                                                                                                                                                                                                                    
      if ( ${n} <= 9 ) then
          # ${RUNDIR}/WRF_RUN/link_grib.csh ${HRRRE_DIR}/${event}/1200/postprd_mem000$n/wrfnat_pert_hrrr_mem000${n}_0[3-9].grib2 ${HRRRE_DIR}/${event}/1200/postprd_mem000$n/wrfnat_pert_hrrr_mem000${n}_1[0-9].grib2 ${HRRRE_DIR}/${event}/1200/postprd_mem000$n/wrfnat_pert_hrrr_mem000${n}_20.grib2 .
          ${RUNDIR}/WRF_RUN/link_grib.csh ${HRRRE_DIR}/${event}/1200/mem0$n/wrfnat_pert_hrrr_mem000${n}_0[3-9].grib2 ${HRRRE_DIR}/${event}/1200/mem0$n/wrfnat_pert_hrrr_mem000${n}_1[0-9].grib2 ${HRRRE_DIR}/${event}/1200/mem0$n/wrfnat_pert_hrrr_mem000${n}_20.grib2 .
        else
          # ${RUNDIR}/WRF_RUN/link_grib.csh ${HRRRE_DIR}/${event}/1200/postprd_mem00$n/wrfnat_pert_hrrr_mem00${n}_0[3-9].grib2 ${HRRRE_DIR}/${event}/1200/postprd_mem00$n/wrfnat_pert_hrrr_mem00${n}_1[0-9].grib2 ${HRRRE_DIR}/${event}/1200/postprd_mem00$n/wrfnat_pert_hrrr_mem00${n}_20.grib2 .
           ${RUNDIR}/WRF_RUN/link_grib.csh ${HRRRE_DIR}/${event}/1200/mem$n/wrfnat_pert_hrrr_mem00${n}_0[3-9].grib2 ${HRRRE_DIR}/${event}/1200/mem$n/wrfnat_pert_hrrr_mem00${n}_1[0-9].grib2 ${HRRRE_DIR}/${event}/1200/mem$n/wrfnat_pert_hrrr_mem00${n}_20.grib2 .
        endif
...
echo '#SBATCH' "-p batch"                                                     >> ${RUNDIR}/ungrib_bc_mem.csh
echo '#SBATCH' "--mem-per-cpu=10G"                                            >> ${RUNDIR}/ungrib_bc_mem.csh
echo '#SBATCH' "-n 1"                                                        >> ${RUNDIR}/ungrib_bc_mem.csh
echo '#SBATCH -t 2:00:00'                                                    >> ${RUNDIR}/ungrib_bc_mem.csh
echo "#=================================================================="   >> ${RUNDIR}/ungrib_bc_mem.csh
echo " "                                                                     >> ${RUNDIR}/ungrib_bc_mem.csh
echo "set echo"                                                              >> ${RUNDIR}/ungrib_bc_mem.csh
echo "source /scratch/wofs_1km/wofs_1km_scripts/WOFenv_rto_d01"                            >> ${RUNDIR}/ungrib_bc_mem.csh
...
echo '#SBATCH' "-p batch"                                                     >> ${RUNDIR}/metgrid_bc_mem.csh
echo '#SBATCH' "--mem-per-cpu=5G"                                            >> ${RUNDIR}/metgrid_bc_mem.csh
echo '#SBATCH' "-n 32"                                                       >> ${RUNDIR}/metgrid_bc_mem.csh
echo '#SBATCH -t 02:00:00'                                                   >> ${RUNDIR}/metgrid_bc_mem.csh
echo "#=================================================================="   >> ${RUNDIR}/metgrid_bc_mem.csh
echo " "                                                                     >> ${RUNDIR}/metgrid_bc_mem.csh
echo "set echo"                                                              >> ${RUNDIR}/metgrid_bc_mem.csh
echo "source /scratch/wofs_1km/wofs_1km_scripts/WOFenv_rto_d01"                            >> ${RUNDIR}/metgrid_bc_mem.csh
