...
echo '#SBATCH' "-A smallqueue"                                                >> ${RUNDIR}/geogrid.csh
...
echo "source /scratch/wofs_1km/wofs_1km_scripts/WOFenv_d01"                                            >> ${RUNDIR}/geogrid.csh
echo "source ${TOP_DIR}/realtime.cfg.${event}"                                   >> ${RUNDIR}/geogrid.csh
