...
#obs_file_5km = ncdf.Dataset('./obs_epoch_5km.nc')
obs_file_3km = ncdf.Dataset('./obs_epoch_3km.nc')

#obs_loc5 = obs_file_5km.variables['location']
#num_obs5 = len(obs_loc5[:,0])
...
#   if obs < num_obs5:
#    location5 = obs_loc5[obs,:]
#    lat5 = location5[1]
#    lon5 = location5[0]-360.0     

#    for i in range(0,len(latmin)):

#     if lat5 >= latmin[i] and lat5 <= latmax[i] and lon5 >= lonmin[i] and lon5 <= lonmax[i]:   #Find 5 km obs in high variance area
#      set_5km.append(obs+1)
#      break
...
#fout.createDimension('5km_obs_num', len(set_5km))
...
#obs_5km_var = fout.createVariable('5_km_obs_noassim', 'f4', ('5km_obs_num',))
#obs_5km_var.long_name = "5 km observations to NOT assimilate"
#obs_5km_var.units = "Obs Number"

fout.variables['3_km_obs_assim'][:] = set_3km
#fout.variables['5_km_obs_noassim'][:] = set_5km
...
#print('starting 5 km')
#m = -1
#with open(file_5km) as f2:

# for i in range(1,num_obs5+1):
#  if i in set_5km:
#   if i < 10:
#    phrase=' OBS            '+str(i)
#   if i >= 10 and i < 100:
...
#   if line_num >= 0: lines5[line_num+2] = text


#out = open(file_5km, 'w')
#out.writelines(lines5)
#out.close()
